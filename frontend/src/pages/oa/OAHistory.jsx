      ...
      <main className="pt-14">
        <div className="max-w-6xl mx-auto px-6 lg:px-12 py-12">
          <div className="mb-10">
            ...
            <SectionTitle
              title="OA History"
              subtitle="Review your past OA sessions"
            />
          </div>
                      ...
                      >
                        ...
                        <td className="px-4 py-4">
                          <div className="text-sm">
                            {session.configSnapshot?.selectedCompanies?.length >
                            0 ? (
                              <span>
                                {session.configSnapshot.selectedCompanies
                                  .slice(0, 2)
                                  .join(", ")}
                                {session.configSnapshot.selectedCompanies
                                  .length > 2 &&
                        ...
                        <td className="px-4 py-4">
                          {["submitted", "terminated", "expired"].includes(
                            ...
                            <Button
                              as={Link}
                              to={`/oa/report/${session.sessionId}`}
                              variant="ghost"
                              size="sm"
                            >
                              View Report →
                            ...
                            <Button
                              as={Link}
                              to={`/oa/session/${session.sessionId}`}
                              variant="primary"
                              size="sm"
                            >
                              Resume →
